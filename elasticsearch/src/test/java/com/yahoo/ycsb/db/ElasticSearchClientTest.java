...
public class ElasticSearchClientTest {
	...
	public void testRead() {
		...
		HashMap<String, ByteIterator> resultParam = new HashMap<String, ByteIterator>(
				10);
		int expResult = 0;
	...
	public void testUpdate() {
		...
		int i;
		HashMap<String, ByteIterator> newValues = new HashMap<String, ByteIterator>(
				10);
		...
		for (i = 1; i <= 10; i++) {
			assertEquals("newvalue" + i, resultParam.get("field" + i)
					.toString());
		}
	...
	public void testScan() {
		...
		int recordcount = 10;
		Set<String> fields = MOCK_DATA.keySet();
		Vector<HashMap<String, ByteIterator>> resultParam = new Vector<HashMap<String, ByteIterator>>(
				10);
		int expResult = 0;
		int result = instance.scan(MOCK_TABLE, MOCK_KEY1, recordcount, fields,
				resultParam);
		assertEquals(expResult, result);
	}
}
